...
def plot_daily(results):
    ...
    variables = ['evapotranspiration','canopy_transpiration', 'overstory_transpiration','canopy_evaporation','ffloor_evaporation',
                 'canopy_GPP','overstory_gpp','Tr_pine','Tr_spruce','Tr_birch','gpp_pine','gpp_spruce','gpp_birch', 'vpd']

    Data = xarray_to_df(results, variables, sim_idx=0)

    for var in ['canopy_GPP','overstory_gpp','gpp_pine','gpp_spruce','gpp_birch']:
    ...
    print(Data[['canopy_GPP','overstory_gpp','evapotranspiration','overstory_transpiration']].sum())