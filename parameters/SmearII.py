...
gpara = {
    ...
    'end_time' : "2005-06-08",  # end time of simulation [yyyy-mm-dd]
...
""" --- Soil submodel parameters for 1-layer soil where state is updated from forcing file in pyAPES.driver """

soil_grid = {
    'dz': [0.10],  #thickness of computational layers [m]
    'zh': [-0.10]  # bottom depth of layers with different characteristics [m]
}
